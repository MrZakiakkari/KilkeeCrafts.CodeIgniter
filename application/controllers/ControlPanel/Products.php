...
class Products extends CI_Controller
{
	...
	{
		$this->load->view('admin/ProductSearch');
	}
	public function listproducts()
	{
		...
		$paginationConfig = array(
			'base_url' => site_url('admin/Products/listproducts/'),
		...
		$this->load->view('admin/productListView', $vars);
	}
	...
	public function updateproduct($productId)
	{
		...
		if (!$this->form_validation->run()) {
			...
			$this->load->view('admin/updateproductView', array("product" => $product));
			return;
		}
		...
		if ($this->unauthorizedAdminSessionDetected()) {
			...
			if ($this->input->post('submitInsert')) {
				...
				if (!$this->form_validation->run()) {
					...
					$this->load->view('admin/insertproductView', $product);
					return;
				}
